...
public class NBtoNP {
	...
	{
	String NBsrc = "RobotRendezvous.java";
	String trg = "RobotRendezvousApplet.java";
	String save = "RobotRendezvousAppletSave.txt";
	
	//******************************  Read in from NetBeans
	
	Scanner in = null;
	try {
	in = new Scanner(new File("C:/Documents and Settings/Frederik/My Documents/NetBeansProjects/FractalGUI/src/" + NBsrc));
	} catch (Exception e)
	    {
